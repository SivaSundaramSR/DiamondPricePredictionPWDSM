...
class DataTransformationConfig:
    preprocessor_pkl_file_path = os.path.join("artifacts", "preprocessor.pkl")
...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            # Define which columns should be ordinal-encoded and which should be scaled(try by extracting this using df)
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            #concatinating input and target features
